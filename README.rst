...
+-----------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------+
|.. image:: https://www.uni-kassel.de/eecs/fileadmin/datas/fb16/Fachgebiete/energiemanagement/iee.png | .. image:: https://www.uni-kassel.de/uni/fileadmin/sys/resources/images/logo/logo-main.svg           |
|    :target: https://www.iee.fraunhofer.de/en.html                                                   |     :target: https://www.uni-kassel.de/                                                              |
|    :width: 300em                                                                                    |     :width: 300em                                                                                    |
|                                                                                                     +------------------------------------------------------------------------------------------------------+
