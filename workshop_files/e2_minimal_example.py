...
def minimal_example_power_grid():
    net = pp.create_empty_network(name='minimal example')

    in_buses = pd.read_csv(r'net_data_power/example_net-buses.CSV')
    in_lines =  pd.read_csv(r'net_data_power/example_net-lines.CSV')
    in_loads = pd.read_csv(r'net_data_power/example_net-loads.CSV')
    in_sgens = pd.read_csv(r'net_data_power/example_net-sgens.CSV')
...
if __name__ == '__main__':
    ...
    pp.to_json(net, 'workshop_example_power.json')